...
public partial class TestViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    string _deviceDisplayResolution, _androidResolution;
    ...
    [RelayCommand]
    public void ToggleAndroidResolution()
    {
        if (!String.IsNullOrEmpty(AndroidResolution))
        {
            AndroidResolution = String.Empty;
            return;
        }

        AndroidResolution = ((MainActivity)Platform.CurrentActivity).GetScreenResolution().ToString();
    }
}