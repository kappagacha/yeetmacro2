...
public partial class TestViewModel(ILogger<TestViewModel> logger, MediaProjectionService mediaProjectionService, YeetAccessibilityService accessibilityService,
    OpenCvService openCvService, AndroidScreenService screenService) : ObservableObject
{
    [ObservableProperty]
    ...
    [ObservableProperty]
    string _deviceDisplayResolution, _customResolution, _topLeft, _testMessage;
    ...
    readonly MediaProjectionService _mediaProjectionService = mediaProjectionService;
    readonly YeetAccessibilityService _accessibilityService = accessibilityService;
    readonly OpenCvService _openCvService = openCvService;
