	...
	switch (loopResult.Path) {
		...
		case 'town.enter':
			...
			if (soulRestNotification.IsSuccess) {
				...
				macroService.PollPattern(patterns.town.rest.restAll, { DoClick: true, ClickPattern: [patterns.town.rest.autoSelect, patterns.town.rest.restAll.confirm], PredicatePattern: [patterns.town.rest.restAll.disabled, patterns.town.rest.autoSelect.disabled] });
				macroService.PollPattern(patterns.general.back, { DoClick: true, PredicatePattern: patterns.town.enter });
			}
