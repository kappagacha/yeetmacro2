...
function applyTeamConfiguration(team, chainOrderOpts = {}) {
	...
	for ([location, character] of Object.entries(team)) {
		...
		const allCharacterResult = macroService.PollPattern(allCharacterPattern, { DoClick: true, ClickPattern: [patterns.battle.teamFormation[location].add, patterns.battle.teamFormation[location].remove], PredicatePattern: characterPattern, TimeoutMs: 6_000 });
