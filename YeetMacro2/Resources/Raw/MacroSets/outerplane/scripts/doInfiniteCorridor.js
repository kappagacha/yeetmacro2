...
while (macroService.IsRunning) {
	...
	switch (loopResult.Path) {
		...
		case 'challenge.archdemonRuins.infiniteCorridor':
			...
			macroService.PollPattern(patterns.challenge.archdemonRuins.infiniteCorridor.endSearch, { DoClick: true, PredicatePattern: [patterns.challenge.archdemonRuins.infiniteCorridor, patterns.challenge.archdemonRuins.infiniteCorridor.stage3] });
