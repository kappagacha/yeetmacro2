...
while (macroService.IsRunning) {
	...
	switch (loopResult.Path) {
		...
		case 'mall':
			...
			macroService.PollPattern(brilliantGiftBoxPattern, { DoClick: true, PredicatePattern: patterns.mall.purchase });
			...
			macroService.PollPattern(fairyNetSupportFundPattern, { DoClick: true, PredicatePattern: patterns.mall.purchase.confirm });
			macroService.PollPattern(patterns.mall.purchase.confirm, { DoClick: true, PredicatePattern: patterns.general.touchTheScreen });
			macroService.PollPattern(patterns.general.touchTheScreen, { DoClick: true, PredicatePattern: patterns.mall });
